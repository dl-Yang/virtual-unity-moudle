...
IL_0041:
	...
	{
		String_t* L_13 = ___0_targetUrl;
		NullCheck(L_13);
		bool L_14;
		L_14 = String_Contains_m7A165D1B2CDCE967F4522BA710CE7FA05EFA2982(L_13, _stringLiteral6A1D52382547009AB732F651FE2CA42F1BBA769A, 4, NULL);
...
IL_005c:
	...
	{
		Regex_tE773142C2BE45C5D362B0F815AFF831707A51772* L_16 = ((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex;
		V_8 = (bool)((((RuntimeObject*)(Regex_tE773142C2BE45C5D362B0F815AFF831707A51772*)L_16) == ((RuntimeObject*)(RuntimeObject*)NULL))? 1 : 0);
		bool L_17 = V_8;
		if (!L_17)
		{
			goto IL_0082;
	...
	}
	{
		...
		Regex__ctor_m082970AA73B8236360F0CA651FA24A8D1EBF89CD(L_18, _stringLiteral665437E312D2053C5919723E2E7EA49D0A2ADE1F, NULL);
		((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex = L_18;
		Il2CppCodeGenWriteBarrier((void**)(&((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex), (void*)L_18);
	}

IL_0082:
	{
		Regex_tE773142C2BE45C5D362B0F815AFF831707A51772* L_19 = ((WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_StaticFields*)il2cpp_codegen_static_fields_for(WebRequestUtils_t23F1FB533DBFDA3BE5624D901D535B4C6EFAD443_il2cpp_TypeInfo_var))->___domainRegex;
		String_t* L_20 = ___0_targetUrl;
		NullCheck(L_19);
		bool L_21;
		L_21 = Regex_IsMatch_m7E96E666FBE7259D7638A3A6A21BE824D2406F49(L_19, L_20, NULL);
		V_9 = L_21;
		bool L_22 = V_9;
		if (!L_22)
		{
	...
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_23 = V_1;
		NullCheck(L_23);
		String_t* L_24;
		L_24 = Uri_get_Scheme_m29106D5109538220B22FC49DE7B44040E51B0F6F(L_23, NULL);
		String_t* L_25 = ___0_targetUrl;
		String_t* L_26;
		L_26 = String_Concat_m8855A6DE10F84DA7F4EC113CADDB59873A25573B(L_24, _stringLiteral6A1D52382547009AB732F651FE2CA42F1BBA769A, L_25, NULL);
		___0_targetUrl = L_26;
		V_0 = (bool)1;
	}
	...
	{
		{
			...
			il2cpp_codegen_runtime_class_init_inline(Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E_il2cpp_TypeInfo_var);
			bool L_28;
			L_28 = Uri_op_Equality_mD7D7AAB7023C0873B37D8B8C7195BEF34002A194(L_27, (Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E*)NULL, NULL);
			if (!L_28)
			{
				goto IL_00c7_1;
			}
		...
		{
			String_t* L_29 = ___0_targetUrl;
			NullCheck(L_29);
			Il2CppChar L_30;
			L_30 = String_get_Chars_mC49DF0CD2D3BE7BE97B3AD9C995BE3094F8E36D3(L_29, 0, NULL);
			G_B17_0 = ((((int32_t)((((int32_t)L_30) == ((int32_t)((int32_t)46)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
			goto IL_00c8_1;
		}
...
IL_00c8_1:
		...
		}
		{
			...
			Uri__ctor_m6CA436E6AD2768A121FA851CBEEFA3623E849D3A(L_33, L_32, NULL);
			V_2 = L_33;
		}
...
CATCH_00d8:
	{
		FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B* L_34 = ((FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B*)IL2CPP_GET_ACTIVE_EXCEPTION(FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B*));;
		V_11 = L_34;
		FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B* L_35 = V_11;
		V_3 = L_35;
...
IL_00e1:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E_il2cpp_TypeInfo_var);
		bool L_37;
		L_37 = Uri_op_Equality_mD7D7AAB7023C0873B37D8B8C7195BEF34002A194(L_36, (Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E*)NULL, NULL);
		V_12 = L_37;
		bool L_38 = V_12;
		if (!L_38)
		{
	...
	try
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_39 = V_1;
		String_t* L_40 = ___0_targetUrl;
		...
		Uri__ctor_mD7EC916948CBFE71F80298DDA6E4209724958B09(L_41, L_39, L_40, NULL);
		V_2 = L_41;
		V_0 = (bool)1;
		goto IL_0100;
	}
...
CATCH_00fc:
	{
		...
		FormatException_tCD210E92627903FFEDAAA706C08FB6222B4D012B* L_43 = V_3;
		IL2CPP_POP_ACTIVE_EXCEPTION(Exception_t*);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_43, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&WebRequestUtils_MakeInitialUrl_m30A37413A904FEB4E4E45607E929B4E90ECE044C_RuntimeMethod_var)));
	}

IL_0100:
	{
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_44 = V_2;
		String_t* L_45 = ___0_targetUrl;
		bool L_46 = V_0;
		String_t* L_47;
		L_47 = WebRequestUtils_MakeUriString_mC95B57536DF28E6A9FE768A31BD7CE6AC976D837(L_44, L_45, L_46, NULL);
		V_5 = L_47;
		goto IL_010c;
	}
...
IL_002b:
	{
		...
		NullCheck(L_12);
		bool L_13;
		L_13 = String_Contains_m7A165D1B2CDCE967F4522BA710CE7FA05EFA2982(L_12, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, 4, NULL);
		V_6 = L_13;
		bool L_14 = V_6;
		if (!L_14)
		{
	...
	}
	{
		...
		NullCheck(L_15);
		bool L_16;
		L_16 = String_Contains_m182EA83138C61663D7F45F699EE295F0E70FD581(L_15, ((int32_t)43), 4, NULL);
		V_7 = L_16;
		bool L_17 = V_7;
		if (!L_17)
		{
